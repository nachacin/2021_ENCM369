...
void UserAppInitialize(void)
{
    ...
    /* Initialize DAC1 input register at 0V */
    DAC1DATL = 0;
...
{
    /* Initialize an 8-bit counter to iterate through an array. The counter's
     rollover will be used to loop back to the beginning of the array */
    static u8 u8Index = 0;
    
    /* The following is a comparison of two alternatives of writing the same
     code. Compact vs. Readable. Both retrieve a value from the sine wave lookup
     table and increment the index for the next call*/
#if 0
